...
from cdrl.utils.graph_utils import edge_list_from_adj_matrix
...
def get_metrics_dict(construct_output, prune_output, disc_inst, reward_function):
...
def get_metrics_for_graph(disc_inst, graph, reward_function):
    ...
    metrics_out["reward"] = reward_function.calculate_reward_single_graph(discovered_graph)
