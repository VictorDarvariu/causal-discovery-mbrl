...
##
misc_arg.add_argument('--output_dir', type=str, default='output/{}'.format(datetime.now(timezone('Europe/London')).strftime('%Y-%m-%d_%H-%M-%S-%f')[:-3]), help='root directory for output data')
